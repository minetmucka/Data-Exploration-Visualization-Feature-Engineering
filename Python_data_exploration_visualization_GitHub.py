...
#Python Version: 3.7+                                                       #
#Using Packages: pandas, seaborn, matplotlib                                #
#############################################################################


# Script for following along in Data Exploration and Visualization module
# Set your working directory to where your dataset lives
...
iris = pd.read_csv('C://Users//muckam//Desktop//DataScienceBootcamp//Datasets//Iris_Data.csv')
iris.head()
...
# Saving Plots.
# Saves to current working directory by default
plt.figure()
